...
int ToProtoData(kortex_driver::ActuatorCommand input, ActuatorCommand *output)
{
...
int ToProtoData(kortex_driver::InterconnectCommand input, InterconnectCommand *output)
{
	output->set_command_id(input.command_id);
	output->set_flags(input.flags);
	output->set_position(input.position);
...
int ToProtoData(kortex_driver::ActuatorFeedback input, ActuatorFeedback *output)
{
	output->set_command_id(input.command_id);
...
int ToProtoData(kortex_driver::InterconnectFeedback input, InterconnectFeedback *output)
{
	output->set_command_id(input.command_id);
	output->set_status_flags(input.status_flags);
	output->set_jitter_comm(input.jitter_comm);
...
int ToProtoData(kortex_driver::ActuatorCustomData input, ActuatorCustomData *output)
{
	output->set_command_id(input.command_id);
...
int ToProtoData(kortex_driver::InterconnectCustomData input, InterconnectCustomData *output)
{
	output->set_command_id(input.command_id);
	output->set_custom_data_0(input.custom_data_0);
	output->set_custom_data_1(input.custom_data_1);
...
int ToProtoData(kortex_driver::BaseFeedback input, BaseFeedback *output)
{
...
int ToProtoData(kortex_driver::CustomData input, CustomData *output)
{
...
int ToProtoData(kortex_driver::Command input, Command *output)
{
	output->set_frame_id(input.frame_id); 
...
int ToProtoData(kortex_driver::Feedback input, Feedback *output)
{
	output->set_frame_id(input.frame_id);
