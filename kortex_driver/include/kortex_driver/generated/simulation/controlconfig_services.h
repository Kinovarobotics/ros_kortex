...
class ControlConfigSimulationServices : public IControlConfigServices
{
    public:
        ...
        std::function<kortex_driver::SetGravityVector::Response&(kortex_driver::SetGravityVector::Request&)> SetGravityVectorHandler = nullptr;
        ...
        std::function<kortex_driver::GetGravityVector::Response&(kortex_driver::GetGravityVector::Request&)> GetGravityVectorHandler = nullptr;
        ...
        std::function<kortex_driver::SetPayloadInformation::Response&(kortex_driver::SetPayloadInformation::Request&)> SetPayloadInformationHandler = nullptr;
        ...
        std::function<kortex_driver::GetPayloadInformation::Response&(kortex_driver::GetPayloadInformation::Request&)> GetPayloadInformationHandler = nullptr;
        ...
        std::function<kortex_driver::SetToolConfiguration::Response&(kortex_driver::SetToolConfiguration::Request&)> SetToolConfigurationHandler = nullptr;
        ...
        std::function<kortex_driver::GetToolConfiguration::Response&(kortex_driver::GetToolConfiguration::Request&)> GetToolConfigurationHandler = nullptr;
        ...
        std::function<kortex_driver::OnNotificationControlConfigurationTopic::Response&(kortex_driver::OnNotificationControlConfigurationTopic::Request&)> OnNotificationControlConfigurationTopicHandler = nullptr;
        ...
        std::function<kortex_driver::ControlConfig_Unsubscribe::Response&(kortex_driver::ControlConfig_Unsubscribe::Request&)> ControlConfig_UnsubscribeHandler = nullptr;
        ...
        std::function<kortex_driver::SetCartesianReferenceFrame::Response&(kortex_driver::SetCartesianReferenceFrame::Request&)> SetCartesianReferenceFrameHandler = nullptr;
        ...
        std::function<kortex_driver::GetCartesianReferenceFrame::Response&(kortex_driver::GetCartesianReferenceFrame::Request&)> GetCartesianReferenceFrameHandler = nullptr;
        ...
        std::function<kortex_driver::ControlConfig_GetControlMode::Response&(kortex_driver::ControlConfig_GetControlMode::Request&)> ControlConfig_GetControlModeHandler = nullptr;
        ...
        std::function<kortex_driver::SetJointSpeedSoftLimits::Response&(kortex_driver::SetJointSpeedSoftLimits::Request&)> SetJointSpeedSoftLimitsHandler = nullptr;
        ...
        std::function<kortex_driver::SetTwistLinearSoftLimit::Response&(kortex_driver::SetTwistLinearSoftLimit::Request&)> SetTwistLinearSoftLimitHandler = nullptr;
        ...
        std::function<kortex_driver::SetTwistAngularSoftLimit::Response&(kortex_driver::SetTwistAngularSoftLimit::Request&)> SetTwistAngularSoftLimitHandler = nullptr;
        ...
        std::function<kortex_driver::SetJointAccelerationSoftLimits::Response&(kortex_driver::SetJointAccelerationSoftLimits::Request&)> SetJointAccelerationSoftLimitsHandler = nullptr;
        ...
        std::function<kortex_driver::GetKinematicHardLimits::Response&(kortex_driver::GetKinematicHardLimits::Request&)> GetKinematicHardLimitsHandler = nullptr;
        ...
        std::function<kortex_driver::GetKinematicSoftLimits::Response&(kortex_driver::GetKinematicSoftLimits::Request&)> GetKinematicSoftLimitsHandler = nullptr;
        ...
        std::function<kortex_driver::GetAllKinematicSoftLimits::Response&(kortex_driver::GetAllKinematicSoftLimits::Request&)> GetAllKinematicSoftLimitsHandler = nullptr;
        ...
        std::function<kortex_driver::SetDesiredLinearTwist::Response&(kortex_driver::SetDesiredLinearTwist::Request&)> SetDesiredLinearTwistHandler = nullptr;
        ...
        std::function<kortex_driver::SetDesiredAngularTwist::Response&(kortex_driver::SetDesiredAngularTwist::Request&)> SetDesiredAngularTwistHandler = nullptr;
        ...
        std::function<kortex_driver::SetDesiredJointSpeeds::Response&(kortex_driver::SetDesiredJointSpeeds::Request&)> SetDesiredJointSpeedsHandler = nullptr;
        ...
        std::function<kortex_driver::GetDesiredSpeeds::Response&(kortex_driver::GetDesiredSpeeds::Request&)> GetDesiredSpeedsHandler = nullptr;
        ...
        std::function<kortex_driver::ResetGravityVector::Response&(kortex_driver::ResetGravityVector::Request&)> ResetGravityVectorHandler = nullptr;
        ...
        std::function<kortex_driver::ResetPayloadInformation::Response&(kortex_driver::ResetPayloadInformation::Request&)> ResetPayloadInformationHandler = nullptr;
        ...
        std::function<kortex_driver::ResetToolConfiguration::Response&(kortex_driver::ResetToolConfiguration::Request&)> ResetToolConfigurationHandler = nullptr;
        ...
        std::function<kortex_driver::ResetJointSpeedSoftLimits::Response&(kortex_driver::ResetJointSpeedSoftLimits::Request&)> ResetJointSpeedSoftLimitsHandler = nullptr;
        ...
        std::function<kortex_driver::ResetTwistLinearSoftLimit::Response&(kortex_driver::ResetTwistLinearSoftLimit::Request&)> ResetTwistLinearSoftLimitHandler = nullptr;
        ...
        std::function<kortex_driver::ResetTwistAngularSoftLimit::Response&(kortex_driver::ResetTwistAngularSoftLimit::Request&)> ResetTwistAngularSoftLimitHandler = nullptr;
        ...
        std::function<kortex_driver::ResetJointAccelerationSoftLimits::Response&(kortex_driver::ResetJointAccelerationSoftLimits::Request&)> ResetJointAccelerationSoftLimitsHandler = nullptr;
