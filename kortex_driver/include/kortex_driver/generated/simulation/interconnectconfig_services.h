...
class InterconnectConfigSimulationServices : public IInterconnectConfigServices
{
    public:
        ...
        std::function<kortex_driver::GetUARTConfiguration::Response&(kortex_driver::GetUARTConfiguration::Request&)> GetUARTConfigurationHandler = nullptr;
        ...
        std::function<kortex_driver::SetUARTConfiguration::Response&(kortex_driver::SetUARTConfiguration::Request&)> SetUARTConfigurationHandler = nullptr;
        ...
        std::function<kortex_driver::GetEthernetConfiguration::Response&(kortex_driver::GetEthernetConfiguration::Request&)> GetEthernetConfigurationHandler = nullptr;
        ...
        std::function<kortex_driver::SetEthernetConfiguration::Response&(kortex_driver::SetEthernetConfiguration::Request&)> SetEthernetConfigurationHandler = nullptr;
        ...
        std::function<kortex_driver::GetGPIOConfiguration::Response&(kortex_driver::GetGPIOConfiguration::Request&)> GetGPIOConfigurationHandler = nullptr;
        ...
        std::function<kortex_driver::SetGPIOConfiguration::Response&(kortex_driver::SetGPIOConfiguration::Request&)> SetGPIOConfigurationHandler = nullptr;
        ...
        std::function<kortex_driver::GetGPIOState::Response&(kortex_driver::GetGPIOState::Request&)> GetGPIOStateHandler = nullptr;
        virtual bool GetGPIOState(kortex_driver::GetGPIOState::Request  &req, kortex_driver::GetGPIOState::Response &res) override;
        std::function<kortex_driver::SetGPIOState::Response&(kortex_driver::SetGPIOState::Request&)> SetGPIOStateHandler = nullptr;
        virtual bool SetGPIOState(kortex_driver::SetGPIOState::Request  &req, kortex_driver::SetGPIOState::Response &res) override;
        std::function<kortex_driver::GetI2CConfiguration::Response&(kortex_driver::GetI2CConfiguration::Request&)> GetI2CConfigurationHandler = nullptr;
        ...
        std::function<kortex_driver::SetI2CConfiguration::Response&(kortex_driver::SetI2CConfiguration::Request&)> SetI2CConfigurationHandler = nullptr;
        ...
        std::function<kortex_driver::I2CRead::Response&(kortex_driver::I2CRead::Request&)> I2CReadHandler = nullptr;
        virtual bool I2CRead(kortex_driver::I2CRead::Request  &req, kortex_driver::I2CRead::Response &res) override;
        std::function<kortex_driver::I2CReadRegister::Response&(kortex_driver::I2CReadRegister::Request&)> I2CReadRegisterHandler = nullptr;
        ...
        std::function<kortex_driver::I2CWrite::Response&(kortex_driver::I2CWrite::Request&)> I2CWriteHandler = nullptr;
        virtual bool I2CWrite(kortex_driver::I2CWrite::Request  &req, kortex_driver::I2CWrite::Response &res) override;
        std::function<kortex_driver::I2CWriteRegister::Response&(kortex_driver::I2CWriteRegister::Request&)> I2CWriteRegisterHandler = nullptr;
