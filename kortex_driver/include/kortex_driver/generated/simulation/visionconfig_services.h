...
class VisionConfigSimulationServices : public IVisionConfigServices
{
    public:
        ...
        std::function<kortex_driver::SetSensorSettings::Response&(kortex_driver::SetSensorSettings::Request&)> SetSensorSettingsHandler = nullptr;
        ...
        std::function<kortex_driver::GetSensorSettings::Response&(kortex_driver::GetSensorSettings::Request&)> GetSensorSettingsHandler = nullptr;
        ...
        std::function<kortex_driver::GetOptionValue::Response&(kortex_driver::GetOptionValue::Request&)> GetOptionValueHandler = nullptr;
        virtual bool GetOptionValue(kortex_driver::GetOptionValue::Request  &req, kortex_driver::GetOptionValue::Response &res) override;
        std::function<kortex_driver::SetOptionValue::Response&(kortex_driver::SetOptionValue::Request&)> SetOptionValueHandler = nullptr;
        virtual bool SetOptionValue(kortex_driver::SetOptionValue::Request  &req, kortex_driver::SetOptionValue::Response &res) override;
        std::function<kortex_driver::GetOptionInformation::Response&(kortex_driver::GetOptionInformation::Request&)> GetOptionInformationHandler = nullptr;
        ...
        std::function<kortex_driver::OnNotificationVisionTopic::Response&(kortex_driver::OnNotificationVisionTopic::Request&)> OnNotificationVisionTopicHandler = nullptr;
        ...
        std::function<kortex_driver::DoSensorFocusAction::Response&(kortex_driver::DoSensorFocusAction::Request&)> DoSensorFocusActionHandler = nullptr;
        ...
        std::function<kortex_driver::GetIntrinsicParameters::Response&(kortex_driver::GetIntrinsicParameters::Request&)> GetIntrinsicParametersHandler = nullptr;
        ...
        std::function<kortex_driver::GetIntrinsicParametersProfile::Response&(kortex_driver::GetIntrinsicParametersProfile::Request&)> GetIntrinsicParametersProfileHandler = nullptr;
        ...
        std::function<kortex_driver::SetIntrinsicParameters::Response&(kortex_driver::SetIntrinsicParameters::Request&)> SetIntrinsicParametersHandler = nullptr;
        ...
        std::function<kortex_driver::GetExtrinsicParameters::Response&(kortex_driver::GetExtrinsicParameters::Request&)> GetExtrinsicParametersHandler = nullptr;
        ...
        std::function<kortex_driver::SetExtrinsicParameters::Response&(kortex_driver::SetExtrinsicParameters::Request&)> SetExtrinsicParametersHandler = nullptr;
