...
class DeviceConfigSimulationServices : public IDeviceConfigServices
{
    public:
        ...
        std::function<kortex_driver::GetRunMode::Response&(kortex_driver::GetRunMode::Request&)> GetRunModeHandler = nullptr;
        virtual bool GetRunMode(kortex_driver::GetRunMode::Request  &req, kortex_driver::GetRunMode::Response &res) override;
        std::function<kortex_driver::SetRunMode::Response&(kortex_driver::SetRunMode::Request&)> SetRunModeHandler = nullptr;
        virtual bool SetRunMode(kortex_driver::SetRunMode::Request  &req, kortex_driver::SetRunMode::Response &res) override;
        std::function<kortex_driver::GetDeviceType::Response&(kortex_driver::GetDeviceType::Request&)> GetDeviceTypeHandler = nullptr;
        virtual bool GetDeviceType(kortex_driver::GetDeviceType::Request  &req, kortex_driver::GetDeviceType::Response &res) override;
        std::function<kortex_driver::GetFirmwareVersion::Response&(kortex_driver::GetFirmwareVersion::Request&)> GetFirmwareVersionHandler = nullptr;
        ...
        std::function<kortex_driver::GetBootloaderVersion::Response&(kortex_driver::GetBootloaderVersion::Request&)> GetBootloaderVersionHandler = nullptr;
        ...
        std::function<kortex_driver::GetModelNumber::Response&(kortex_driver::GetModelNumber::Request&)> GetModelNumberHandler = nullptr;
        virtual bool GetModelNumber(kortex_driver::GetModelNumber::Request  &req, kortex_driver::GetModelNumber::Response &res) override;
        std::function<kortex_driver::GetPartNumber::Response&(kortex_driver::GetPartNumber::Request&)> GetPartNumberHandler = nullptr;
        virtual bool GetPartNumber(kortex_driver::GetPartNumber::Request  &req, kortex_driver::GetPartNumber::Response &res) override;
        std::function<kortex_driver::GetSerialNumber::Response&(kortex_driver::GetSerialNumber::Request&)> GetSerialNumberHandler = nullptr;
        ...
        std::function<kortex_driver::GetMACAddress::Response&(kortex_driver::GetMACAddress::Request&)> GetMACAddressHandler = nullptr;
        virtual bool GetMACAddress(kortex_driver::GetMACAddress::Request  &req, kortex_driver::GetMACAddress::Response &res) override;
        std::function<kortex_driver::GetIPv4Settings::Response&(kortex_driver::GetIPv4Settings::Request&)> GetIPv4SettingsHandler = nullptr;
        ...
        std::function<kortex_driver::SetIPv4Settings::Response&(kortex_driver::SetIPv4Settings::Request&)> SetIPv4SettingsHandler = nullptr;
        ...
        std::function<kortex_driver::GetPartNumberRevision::Response&(kortex_driver::GetPartNumberRevision::Request&)> GetPartNumberRevisionHandler = nullptr;
        ...
        std::function<kortex_driver::RebootRequest::Response&(kortex_driver::RebootRequest::Request&)> RebootRequestHandler = nullptr;
        virtual bool RebootRequest(kortex_driver::RebootRequest::Request  &req, kortex_driver::RebootRequest::Response &res) override;
        std::function<kortex_driver::SetSafetyEnable::Response&(kortex_driver::SetSafetyEnable::Request&)> SetSafetyEnableHandler = nullptr;
        ...
        std::function<kortex_driver::SetSafetyErrorThreshold::Response&(kortex_driver::SetSafetyErrorThreshold::Request&)> SetSafetyErrorThresholdHandler = nullptr;
        ...
        std::function<kortex_driver::SetSafetyWarningThreshold::Response&(kortex_driver::SetSafetyWarningThreshold::Request&)> SetSafetyWarningThresholdHandler = nullptr;
        ...
        std::function<kortex_driver::SetSafetyConfiguration::Response&(kortex_driver::SetSafetyConfiguration::Request&)> SetSafetyConfigurationHandler = nullptr;
        ...
        std::function<kortex_driver::GetSafetyConfiguration::Response&(kortex_driver::GetSafetyConfiguration::Request&)> GetSafetyConfigurationHandler = nullptr;
        ...
        std::function<kortex_driver::GetSafetyInformation::Response&(kortex_driver::GetSafetyInformation::Request&)> GetSafetyInformationHandler = nullptr;
        ...
        std::function<kortex_driver::GetSafetyEnable::Response&(kortex_driver::GetSafetyEnable::Request&)> GetSafetyEnableHandler = nullptr;
        ...
        std::function<kortex_driver::GetSafetyStatus::Response&(kortex_driver::GetSafetyStatus::Request&)> GetSafetyStatusHandler = nullptr;
        ...
        std::function<kortex_driver::ClearAllSafetyStatus::Response&(kortex_driver::ClearAllSafetyStatus::Request&)> ClearAllSafetyStatusHandler = nullptr;
        ...
        std::function<kortex_driver::ClearSafetyStatus::Response&(kortex_driver::ClearSafetyStatus::Request&)> ClearSafetyStatusHandler = nullptr;
        ...
        std::function<kortex_driver::GetAllSafetyConfiguration::Response&(kortex_driver::GetAllSafetyConfiguration::Request&)> GetAllSafetyConfigurationHandler = nullptr;
        ...
        std::function<kortex_driver::GetAllSafetyInformation::Response&(kortex_driver::GetAllSafetyInformation::Request&)> GetAllSafetyInformationHandler = nullptr;
        ...
        std::function<kortex_driver::ResetSafetyDefaults::Response&(kortex_driver::ResetSafetyDefaults::Request&)> ResetSafetyDefaultsHandler = nullptr;
        ...
        std::function<kortex_driver::OnNotificationSafetyTopic::Response&(kortex_driver::OnNotificationSafetyTopic::Request&)> OnNotificationSafetyTopicHandler = nullptr;
        ...
        std::function<kortex_driver::ExecuteCalibration::Response&(kortex_driver::ExecuteCalibration::Request&)> ExecuteCalibrationHandler = nullptr;
        ...
        std::function<kortex_driver::GetCalibrationResult::Response&(kortex_driver::GetCalibrationResult::Request&)> GetCalibrationResultHandler = nullptr;
        ...
        std::function<kortex_driver::StopCalibration::Response&(kortex_driver::StopCalibration::Request&)> StopCalibrationHandler = nullptr;
        ...
        std::function<kortex_driver::DeviceConfig_SetCapSenseConfig::Response&(kortex_driver::DeviceConfig_SetCapSenseConfig::Request&)> DeviceConfig_SetCapSenseConfigHandler = nullptr;
        ...
        std::function<kortex_driver::DeviceConfig_GetCapSenseConfig::Response&(kortex_driver::DeviceConfig_GetCapSenseConfig::Request&)> DeviceConfig_GetCapSenseConfigHandler = nullptr;
