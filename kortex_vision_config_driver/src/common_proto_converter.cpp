...
int ToProtoData(kortex_vision_config_driver::DeviceHandle input, DeviceHandle *output)
{
...
int ToProtoData(kortex_vision_config_driver::Empty input, Empty *output)
{

	return 0;
}
int ToProtoData(kortex_vision_config_driver::NotificationOptions input, NotificationOptions *output)
{
...
int ToProtoData(kortex_vision_config_driver::SafetyHandle input, SafetyHandle *output)
{
	output->set_identifier(input.identifier);

	return 0;
}
int ToProtoData(kortex_vision_config_driver::NotificationHandle input, NotificationHandle *output)
{
	output->set_identifier(input.identifier);

	return 0;
}
int ToProtoData(kortex_vision_config_driver::SafetyNotification input, SafetyNotification *output)
{
...
int ToProtoData(kortex_vision_config_driver::Timestamp input, Timestamp *output)
{
...
int ToProtoData(kortex_vision_config_driver::Connection input, Connection *output)
{
	ToProtoData(input.user_handle, output->mutable_user_handle());
